    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-green-50 flex items-center justify-center p-4 pb-safe overflow-x-hidden w-full max-w-full">
      <div className="w-full max-w-2xl overflow-hidden">
        <Card className="w-full border-0 shadow-2xl overflow-hidden">
          <CardContent className="p-6 sm:p-8 md:p-12 text-center space-y-5 sm:space-y-6 w-full overflow-hidden">
            {/* 축하 아이콘 */}
            <div className="text-5xl sm:text-6xl mb-3 sm:mb-4">🎉</div>
            
            {/* 메인 메시지 */}
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 leading-tight px-2 break-words w-full">
              기후시민이 되신 것을 환영합니다!
            </h1>
            <p className="text-base sm:text-lg text-gray-600 leading-relaxed px-2 break-words w-full">
              당신의 선언이 기후위기 대응에 큰 힘이 됩니다.
            </p>

            {/* 공유하기 섹션 */}
            <div className="bg-gradient-to-r from-green-100 to-blue-100 border-2 border-green-200 rounded-xl p-5 sm:p-6 space-y-4 w-full overflow-hidden">
            ...
            {/* 다음 단계 */}
            <div className="bg-green-50 rounded-xl p-5 sm:p-6 space-y-3 sm:space-y-4 text-left w-full overflow-hidden">
              <h2 className="font-semibold text-gray-900 text-base sm:text-lg break-words">다음 단계</h2>
              <ul className="space-y-2 text-gray-700 text-sm sm:text-base leading-relaxed w-full">
                <li className="break-words">• 지역 기후 모임에 참여해보세요</li>
                <li className="break-words">• LNG 발전소 반대 운동에 동참하세요</li>
              </ul>
            </div>

            {/* 버튼들 */}
            <div className="space-y-3 sm:space-y-4 pt-2 w-full overflow-hidden">
              <Button
                onClick={() => router.push("/")}
                size="lg"
