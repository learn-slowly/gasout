                    ...
                    <CardContent className="p-6 sm:p-8 md:p-12 text-center space-y-6 sm:space-y-8 w-full max-w-full overflow-hidden">
                        ...
                        <div className="space-y-3 sm:space-y-4 w-full max-w-full overflow-hidden">
                            ...
                            <p className="text-base sm:text-lg text-gray-700 leading-relaxed px-2 break-words overflow-wrap-anywhere w-full max-w-full">
                                경남기후위기비상행동과 함께 <strong className="text-green-700">'기후시민 선언'</strong>에 참여해 친환경 에너지 전환을 지지하고, 더 나은 지역의 미래를 만들어주세요.
                            </p>
                        </div>

                        {/* MBTI 테스트 안내 */}
                        <div className="bg-purple-50 rounded-xl p-5 sm:p-6 text-center w-full max-w-full overflow-hidden">
                            <h3 className="font-semibold text-gray-900 mb-2 text-base sm:text-lg break-words overflow-wrap-anywhere">
